            ...
            try {
                ...
                if (!error.equals("OK")) {
                    ...
                    if (stat < 0) {
                        try {
                            if (!newInput) {
                                outer.query.setNotification("Status: Waiting for Compilation !");
                            } else {
                        ...
                        if (!newInput) {
                            outer.query.setNotification("Status: Finished Execution. Fetching Details!");
                        } else {
                        ...
                        if (!newInput) {
                            outer.query.setNotification("Status: Being Compiled !");
                        } else {
                            outPanel.setStatus("Please Wait...");
                        }
                        data = null;
                        ...
                        if (!newInput) {
                            outer.query.setNotification("Status: Being Executed !");
                        } else {
                            outPanel.setStatus("Please Wait...");
                        }
                        data = null;
                ...
                if (!newInput) {
                    ...
                    outer.query.disableProgressBar();
