...
public class CodeIt extends JFrame {
    ...
    private void create() {
        ...
        query = new QueryInProgress();
        Thread thread = new Thread(new FetchListOfLanguages(this, this));
        thread.start();
        //pack();
    ...
    void displayStatus(String user, String pass, String sourceCode, Integer key, String input, boolean enabled, boolean privateEnabled) {
        ...
        Thread thread = new Thread(new CreateSubmission(false, user, pass, sourceCode, key, input, enabled, privateEnabled, this, new OutputPanel()));
        thread.start();
        revalidate();
        repaint();
    }
